  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-glow":
          "conic-gradient(from 180deg at 50% 50%, #00FFB2 0deg, #00ff2aff 180deg, #00FFB2 360deg)",
      },
      keyframes: {
        "glow-move": {
        ...
        "slow-glitch": {
          "0%, 100%": {
            transform: "translate(0) rotate(0deg) skew(0deg)",
            filter: "brightness(1)",
          },
          "25%": {
            transform: "translate(-25px, 15px) rotate(1deg) skew(0.5deg)",
            filter: "brightness(1.2)",
          },
          "50%": {
            transform: "translate(25px, -25px) rotate(-1deg) skew(-0.5deg)",
            filter: "brightness(0.8)",
          },
          "75%": {
            transform: "translate(-15px, -15px) rotate(0.5deg) skew(0deg)",
        ...
        "pixel-move": {
          "0%, 100%": { transform: "translate(0, 0)" },
          "25%": {
            transform: "translate(var(--pixel-distort), calc(-1 * var(--pixel-distort)))",
          },
          "50%": {
            transform: "translate(calc(-1 * var(--pixel-distort)), var(--pixel-distort))",
          },
          "75%": {
            transform: "translate(var(--pixel-distort), var(--pixel-distort))",
          },
        },
      },
      animation: {
  ...
  plugins: [
    function ({ addUtilities }) {
      addUtilities({
        ".cursor-glitch-mask": {
          "mask-image":
            "radial-gradient(var(--glitch-radius, 50px) circle at var(--cursor-x, 0) var(--cursor-y, 0), black 0%, rgba(0,0,0,0.5) 40%, transparent 100%)",
          "-webkit-mask-image":
            "radial-gradient(var(--glitch-radius, 50px) circle at var(--cursor-x, 0) var(--cursor-y, 0), black 0%, rgba(0,0,0,0.5) 40%, transparent 100%)",
        },
        ".glitch-transition": {
